...
void setup() {
  ...
  int refAck[] = {0x43, 0x05, 0x01, 0x01, 0x07};
  ...
  int refSys[] = {0x43, 0x07, 0x02, 0xCA, 0xFF, 0xEE, 0xC0};
  ...
  int refDr1[] = {0x43, 0x06, 0x03, 0x13, 0x01, 0x1d};
  // if button  pressed
  // int refDr1[] = {0x43, 0x06, 0x03, 0x13, 0x00, 0x1b};
  ...
  int refAr1[] = {0x43, 0x07, 0x04, 0x15, 0x00, 0x00, 0x20};
